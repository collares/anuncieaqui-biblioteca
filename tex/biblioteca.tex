...
-    \ 
  ...
  \section{Graph algorithms}
    ...
    \includefile{Dinic's maximum flow algorithm}{../graph}{dinic.cpp}
    \includefile{Successive shortest paths mincost maxflow algorithm}{../graph}{busacker_gowen.cpp}
    \includefile{Gabow's general matching algorithm}{../graph}{gabow.cpp}
